        ...
        <div className="flex flex-col gap-6 border-b border-white/10 pb-12 lg:flex-row lg:items-end lg:justify-between">
          ...
          <form className="group flex w-full max-w-md items-center gap-2">
            <input
              ...
              className="h-12 w-full rounded-full border border-white/15 bg-white/5 px-5 text-sm font-medium text-white outline-none transition-[border-color,background-color] duration-300 placeholder:text-white/40 focus:border-[var(--ga-lime)] focus:bg-white/10"
            />
            <button
              type="submit"
              className="ga-press ga-sheen flex h-12 shrink-0 items-center gap-1.5 rounded-full bg-[var(--ga-lime)] px-5 text-sm font-bold text-[var(--ga-ink-deep)]"
            >
              ...
              <ul className="mt-5 space-y-3">
                {col.links.map((l) => (
                  <li key={l.label}>
                    <Link
                      href={l.href}
                      className="inline-block text-sm text-white/75 transition-colors duration-200 hover:text-[var(--ga-lime)]"
                    >
                      {l.label}
                    </Link>
                  </li>
