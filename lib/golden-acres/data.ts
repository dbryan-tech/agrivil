...
const baseProducts: Product[] = [
  ...
  {
    id: 'p19', slug: 'volta-aromatic-rice', name: 'Volta Perfumed Rice (5kg)', category: 'Grains & Legumes',
    farmerId: 'f10', image: '/golden-acres/produce/aromatic-rice.png', unit: 'bag',
    variableWeight: false, estWeightKg: 5, pricePerKg: 19, priceMin: 95, priceMax: 95,
    refrigerationRequired: false, shelfLifeDays: 360, expiryDate: inDays(360), stockKg: 500,
    lowStockThreshold: 50, status: 'in-stock', organic: false, season: 'Year-round',
    tags: ['Bestseller', 'Local Rice'], description: 'Fragrant, unbleached local Ghanaian rice from the Volta paddies — essential for classic Jollof.',
  },
  {
    id: 'p20', slug: 'pure-red-palm-oil', name: 'Pure Dzomi Red Palm Oil (1L)', category: 'Herbs & Spices',
    farmerId: 'f1', image: '/golden-acres/produce/scotch-bonnet.png', unit: 'bottle',
    variableWeight: false, estWeightKg: 1, pricePerKg: 35, priceMin: 35, priceMax: 35,
    refrigerationRequired: false, shelfLifeDays: 365, expiryDate: inDays(365), stockKg: 150,
    lowStockThreshold: 20, status: 'in-stock', organic: true, season: 'Year-round',
    tags: ['Organic', 'Pure Dzomi'], description: 'Rich, unrefined Ghanaian palm oil spiced with traditional herbs for palava sauce and red-red.',
  },
]
...
export const bundles: Bundle[] = [
  ...
  },
  {
    ...
    items: [
      { productId: 'p19', qty: 1 }, { productId: 'p1', qty: 3 }, { productId: 'p13', qty: 1 },
      { productId: 'p2', qty: 1 }, { productId: 'p18', qty: 1 },
    ],
    price: 135, frequency: 'one-time', serves: 'Feeds 4–6',
  },
  {
  ...
  },
  {
    ...
    description: 'Cowpeas, ripe plantain, onions, pepper and pure palm oil for the ultimate red-red — with a recipe card from Auntie Ama.',
    image: '/golden-acres/produce/ripe-plantain.png', type: 'recipe-kit',
    items: [
      { productId: 'p15', qty: 1 }, { productId: 'p4', qty: 1 },
      { productId: 'p13', qty: 1 }, { productId: 'p2', qty: 1 }, { productId: 'p20', qty: 1 },
    ],
    price: 84, frequency: 'one-time', serves: 'Feeds 4',
  },
]
...
export const recipes: Recipe[] = [
  {
    ...
    time: '45 min',
    productIds: ['p19', 'p1', 'p13', 'p2', 'p18'],
    category: 'Rice & grains',
    serves: 'Serves 4',
    difficulty: 'Medium',
    description:
      'The crown jewel of any Ghanaian gathering — fragrant local Volta rice simmered in a rich tomato, ginger, onion and scotch bonnet stew until every single grain is deeply flavored with that signature smoky party-jollof aroma.',
    ingredients: [
      { productId: 'p19', qty: 1, note: 'washed and drained local perfumed rice' },
      { productId: 'p1', qty: 1, note: 'ripe Roma tomatoes, blended smooth' },
      { productId: 'p13', qty: 1, note: 'one for blending, one sliced for frying' },
      { productId: 'p2', qty: 1, note: 'scotch bonnet peppers to taste' },
      { productId: 'p18', qty: 1, note: 'fresh ginger, peeled and blended' },
    ],
    steps: [
      'Blend the fresh tomatoes, half the onions, ginger, and scotch bonnet peppers into a silky aromatic pepper stew base.',
      'Heat vegetable oil in a heavy-bottomed pot and fry the sliced onions until golden brown and caramelized.',
      'Stir in tomato paste and fry for 3 minutes, then pour in the blended stew base and simmer on medium heat until the oil rises to the top.',
      'Season with salt, bay leaves, and curry powder. Pour in meat or vegetable stock, bring to a rolling boil, and stir in the washed Volta rice.',
      'Cover tightly with foil and pot lid, reduce heat to the lowest setting, and let the rice steam for 25–30 minutes until tender and fluffy.',
      'Allow the base to catch slightly for that irresistible authentic party-jollof smokiness before serving hot with fried plantain.',
    ],
  ...
  },
  {
    ...
    time: '40 min',
    productIds: ['p15', 'p4', 'p13', 'p2', 'p20'],
    category: 'Stews & soups',
    serves: 'Serves 3–4',
    difficulty: 'Easy',
    description:
      'A beloved Ghanaian black-eyed cowpea stew cooked in spiced red palm oil (dzomi), paired with sweet, golden caramelized fried plantain (kelewele/dodo).',
    ingredients: [
      { productId: 'p15', qty: 1, note: 'tender cowpeas, soaked overnight' },
      { productId: 'p4', qty: 2, note: 'very ripe plantains, sliced diagonally' },
      { productId: 'p13', qty: 1, note: 'finely diced red onions' },
      { productId: 'p2', qty: 1, note: 'scotch bonnet peppers, crushed' },
      { productId: 'p20', qty: 1, note: 'pure Dzomi red palm oil' },
    ],
    steps: [
      'Boil the soaked cowpeas with a pinch of salt until soft and creamy, then drain while reserving a cup of the bean broth.',
      'Heat Dzomi red palm oil in a saucepan, fry the diced onions and crushed scotch bonnets until fragrant and translucent.',
      'Pour in blended tomato sauce and simmer for 10 minutes until thick and rich.',
      'Fold in the boiled cowpeas and reserved broth, stirring gently, and let simmer on low heat for 12 minutes to absorb all flavors.',
      'Meanwhile, fry the ripe plantain slices in hot oil until deeply golden and caramelized on both sides.',
      'Serve the piping hot red-red topped with a sprinkle of gari alongside the sweet fried plantains.',
    ],
  ...
  },
  {
    ...
    time: '35 min',
    productIds: ['p9', 'p3', 'p2', 'p13', 'p20'],
    category: 'Stews & soups',
    serves: 'Serves 4',
    difficulty: 'Medium',
    description:
      'Tender cocoyam leaves stewed with garden eggs, melon seeds (agushie), and aromatic red palm oil into a deep, earthy green sauce.',
    ingredients: [
      { productId: 'p9', qty: 2, note: 'freshly picked kontomire leaves, washed and shredded' },
      { productId: 'p3', qty: 1, note: 'boiled white garden eggs, roughly mashed' },
      { productId: 'p2', qty: 1, note: 'scotch bonnet peppers, crushed' },
      { productId: 'p13', qty: 1, note: 'sliced red onions' },
      { productId: 'p20', qty: 1, note: 'unrefined Dzomi palm oil' },
    ],
    steps: [
      'Steam the washed kontomire leaves with a pinch of salt for 4 minutes, then drain and squeeze out all excess moisture.',
      'Boil garden eggs until tender, peel the skin, and mash them into a coarse paste.',
      'Heat palm oil in an earthenware asanka or pot, fry onions and crushed peppers until golden and fragrant.',
      'Add blended melon seeds (agushie paste) without stirring for 3 minutes to form soft, savory curds.',
      'Stir in the mashed garden eggs, shredded kontomire, and smoked fish or shrimp.',
      'Simmer on gentle heat for 8 minutes until rich and thick. Serve with boiled yam, plantain, or rice.',
    ],
