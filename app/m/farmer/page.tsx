...
export default function MobileFarmerCockpitScreen() {
  ...
  return (
    <div className="relative min-h-dvh bg-[#F7F5F0] pb-28 text-[#211A12] select-none antialiased overflow-x-hidden [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
      ...
      {/* App Bar */}
      <header
        className="sticky top-0 z-30 flex h-13 items-center justify-between border-b border-[rgba(33,26,18,0.08)] bg-[#F7F5F0]/90 px-3 backdrop-blur-md"
      ...
      >
        ...
        <div className="flex flex-col text-center">
          ...
          <span className="text-[10px] text-[#0B3B25] font-extrabold">Adwoa Sarponaa Farms</span>
        </div>

        <Link
          href="/m"
          className="rounded-full bg-[#0B3B25]/10 px-2.5 py-1 text-[10.5px] font-black text-[#0B3B25]"
        >
          Store View
        </Link>
      </header>
      ...
      <div className="relative px-3 pt-2.5 space-y-2.5">
        ...
        <div className="rounded-[24px] bg-[#0B3B25] p-4 text-white shadow-md">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-white/80">Available MoMo Balance</span>
            <span className="rounded-full bg-[#7A3F1C] px-2 py-0.5 text-[9px] font-black text-white shadow-xs">
              48h Auto-Payout Active
            </span>
          </div>
          <h2 className="mt-1.5 text-[22px] font-black text-white">
            {formatGHS(2480.0)}
          </h2>
        ...
        <div className="rounded-[24px] bg-[#FDFDFB] p-3.5 shadow-[0_2px_12px_-2px_rgba(33,26,18,0.04),0_6px_18px_-4px_rgba(33,26,18,0.06)]">
          <div className="flex items-center justify-between pb-2 border-b border-[rgba(33,26,18,0.06)]">
            <div className="flex items-center gap-1.5">
              <Scale className="h-3.5 w-3.5 text-[#0B3B25]" />
              <span className="text-[10px] font-black uppercase tracking-[0.14em] text-[#5C5247]">
                Today&apos;s Packing List (2 orders)
              </span>
            </div>
            <span className="text-[10.5px] font-bold text-[#7A3F1C]">Pickup 10:30 AM</span>
          </div>

          <div className="mt-2.5 space-y-2">
            {/* Pick Item 1 */}
            <div className="rounded-2xl bg-white p-3 shadow-2xs border border-[rgba(33,26,18,0.06)] text-xs">
              ...
              <p className="mt-0.5 text-[10.5px] text-[#5C5247] font-semibold">Customer: Ewoke Mensah (KNUST, Kumasi)</p>

              <div className="mt-2 flex items-center gap-2">
                <span className="text-[11px] font-bold text-[#211A12]">Actual Measured Weight:</span>
                <div className="flex items-center gap-1">
                  <input
                    type="text"
                    value={actualWeights['item-1']}
                    onChange={(e) => setActualWeights({ ...actualWeights, 'item-1': e.target.value })}
                    className="h-7 w-14 rounded-xl border border-[rgba(33,26,18,0.12)] bg-[#F7F5F0] text-center font-black text-[#0B3B25] outline-none text-[12px]"
                  />
                  <span className="font-bold text-[#5C5247] text-[11px]">kg</span>
                </div>
                <button
                  type="button"
                  className="ml-auto rounded-full bg-[#0B3B25] px-3 py-1 text-[10.5px] font-black text-white shadow-xs active:scale-95"
                >
                  Confirm
                </button>
              </div>
            ...
            <div className="rounded-2xl bg-white p-3 shadow-2xs border border-[rgba(33,26,18,0.06)] text-xs">
              ...
              <p className="mt-0.5 text-[10.5px] text-[#5C5247] font-semibold">Customer: Ama Serwaa (Ahodwo, Kumasi)</p>
        ...
        <div className="rounded-[24px] bg-[#FDFDFB] p-3.5 shadow-[0_2px_12px_-2px_rgba(33,26,18,0.04),0_6px_18px_-4px_rgba(33,26,18,0.06)]">
          <h2 className="text-[10px] font-black uppercase tracking-[0.14em] text-[#5C5247] pb-2 border-b border-[rgba(33,26,18,0.06)]">
          ...
          <div className="mt-2.5 space-y-2">
            {farmProducts.map((p) => {
              ...
              return (
                <div
                  key={p.id}
                  className="flex items-center justify-between rounded-2xl bg-white p-2.5 shadow-2xs border border-[rgba(33,26,18,0.06)] text-xs"
                >
                  <div className="flex items-center gap-2.5">
                    <div className="relative h-10 w-10 shrink-0 overflow-hidden rounded-xl bg-[#F7F5F0]">
                      <Image
                        src={p.image}
                        alt={p.name}
                        fill
                    ...
                    <div>
                      <h3 className="font-extrabold text-[#211A12] text-[12.5px]">{p.name}</h3>
                      <span className="text-[10.5px] text-[#0B3B25] font-black">
                  ...
                  <button
                    ...
                    className={`rounded-full px-3 py-1 text-[10.5px] font-black shadow-xs transition-all active:scale-95 ${
                      inStock
