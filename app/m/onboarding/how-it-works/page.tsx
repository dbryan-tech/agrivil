...
export default function HowItWorksScreen() {
  ...
  return (
    <div className="relative flex min-h-dvh flex-col justify-between overflow-hidden bg-[#FAF7F0] px-6 py-6 sm:px-8">
      ...
      {/* Center Body Content */}
      <div className="relative z-10 my-auto flex flex-col pt-4 pb-4">
        <div className="max-w-xs">
          <h1 className="ga-headline text-3xl font-extrabold tracking-tight text-[#2B1F17] sm:text-4xl">
            How <span className="text-[#0F7A43]">Agrivil</span> works
          </h1>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="flex items-start gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full border-2 border-[#7A3F1C]/20 bg-white text-[#7A3F1C] shadow-xs">
