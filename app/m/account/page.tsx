...
export default function MobileAccountScreen() {
  ...
  return (
    <div className="relative min-h-dvh w-full bg-[#FAF9F6] pb-28 text-[#211A12] select-none antialiased overflow-x-hidden [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
      ...
      {/* Header */}
      <header
        className="sticky top-0 z-30 flex items-center justify-between px-2 py-2.5 border-b border-[rgba(33,26,18,0.05)] bg-[#FAF7F2]/95 backdrop-blur-md rounded-b-[24px] shadow-[0_4px_16px_-4px_rgba(33,26,18,0.06)] transition-all"
        style={{
