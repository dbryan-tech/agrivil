...
/**
 * Home page — RESTORED original rich lineup (owner review 2026-08-22).
 * Video hero, promo, trust strip, category tiles, deals rail, featured
 * produce, freshness story, match teaser, bundles, recipes, farmer
 * spotlight, testimonials — the full old sequence the owner scored 7/10.
 */
